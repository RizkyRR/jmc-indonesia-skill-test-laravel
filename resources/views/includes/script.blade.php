...
<script src="{{ asset('admin-assets/libs/datatables/DataTables-1.12.1/js/dataTables.bootstrap4.min.js') }}"></script>
<script src="{{ asset('admin-assets/libs/datatables/FixedHeader-3.2.3/js/fixedHeader.bootstrap4.min.js') }}"></script>
<script src="{{ asset('admin-assets/libs/datatables/Responsive-2.3.0/js/responsive.bootstrap4.min.js') }}"></script>
<script src="{{ asset('admin-assets/libs/datatables/Responsive-2.3.0/js/responsive.dataTables.min.js') }}"></script>
<script
  src="{{ asset('admin-assets/libs/datatables/jquery-datatables-checkboxes-1.2.12/js/dataTables.checkboxes.min.js') }}">
</script>
