...
<link rel="stylesheet"
  href="{{ asset('admin-assets/libs/datatables/DataTables-1.12.1/css/dataTables.bootstrap4.min.css') }}">
<link rel="stylesheet"
  href="{{ asset('admin-assets/libs/datatables/FixedHeader-3.2.3/css/fixedHeader.bootstrap4.min.css') }}">
<link rel="stylesheet"
  href="{{ asset('admin-assets/libs/datatables/Responsive-2.3.0/css/responsive.bootstrap4.min.css') }}">
<link rel="stylesheet"
  href="{{ asset('admin-assets/libs/datatables/Responsive-2.3.0/css/responsive.dataTables.min.css') }}">
<link rel="stylesheet"
...
<script src="{{ asset('admin-assets/libs/jquery-validation/dist/jquery.validate.min.js') }}" defer></script>
<script src="{{ asset('admin-assets/libs/jquery-validation/dist/additional-methods.min.js') }}" defer></script>
<script src="{{ asset('admin-assets/libs/jquery-validation/src/localization/messages_id.js') }}" defer></script>
