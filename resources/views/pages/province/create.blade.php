...
@section('content')
  <nav aria-label="breadcrumb">
    <ol class="breadcrumb">
      ...
      <li class="breadcrumb-item active">Create New Province</li>
    </ol>
  </nav>
  ...
  <div class="row">
    <div class="col-12">
      <div class="card mb-4">
        ...
        <div class="card-body">
          <form action="{{ route('province.store') }}" method="POST" id="form-province" enctype="multipart/form-data">
            @csrf
            ...
            <div class="mb-3">
              ...
              <input type="text" class="form-control" id="name_province" name="name_province"
                placeholder="Masukkan nama provinsi" value="{{ old('name_province') }}" />
            </div>
