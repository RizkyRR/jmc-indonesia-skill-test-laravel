...
@section('content')
  <nav aria-label="breadcrumb">
    <ol class="breadcrumb">
      ...
      <li class="breadcrumb-item active">Create New Region</li>
    </ol>
  </nav>
    ...
    <div class="col-12">
      <div class="card mb-4">
        <div class="card-header d-flex justify-content-between align-items-center">
          <h5 class="mb-0">Create New Region</h5>
        ...
        <div class="card-body">
          <form action="{{ route('region.store') }}" method="POST" id="form-region" enctype="multipart/form-data">
            @csrf
            ...
            <div class="mb-3">
              ...
              <input type="text" class="form-control" id="name_region" name="name_region"
                placeholder="Masukkan nama region" value="{{ old('name_region') }}" />
            </div>
            ...
            <div class="mb-3">
              ...
              <input type="text" class="form-control" id="total_population_region" name="total_population_region"
                placeholder="Masukkan jumlah populasi" value="{{ old('total_population_region') }}" />
            </div>
